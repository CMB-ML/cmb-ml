...
from cmbml.sims import (
    ...
    ParamConfigExecutor,
    NearParamConfigExecutor,
    TheoryPSExecutor,
    NearTheoryPSExecutor
)
...
@hydra.main(version_base=None, config_name="config_sim_surr2")
def run_simulations(cfg):
    ...
    pipeline_context.add_pipe(NearParamConfigExecutor)
    pipeline_context.add_pipe(NearTheoryPSExecutor)
